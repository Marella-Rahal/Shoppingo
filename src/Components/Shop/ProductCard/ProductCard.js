...
function ProductCard(props) {
    ...
    return (
        <div className='card' style={{width:'200px' ,marginInline:'10px',marginBottom:'20px',paddingBottom:'20px'}}>
            ...
            <button className='card-img-overlay heart-btn'>
            <Favorite/>
            </button>  
            ...
            <div style={{textAlign:'center'}}>
                <Star id="star1" className='star-btn'/>
                <Star id="star2" className='star-btn'/>
                <Star id="star3" className='star-btn'/>
                <Star id="star4" className='star-btn'/>
                <Star id="star5" className='star-btn'/>
            </div>
